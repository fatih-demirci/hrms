...
export default function Cv(jobSeekerid = 22) {

    const [cv, setCv] = useState([])

    let cvService = new CvService()
    cvService.getCv(22).then(result => setCv(result.data.data))
    ...
    //    schoolService.getAllSchoolSorted(22).then(result => setSchools(result.data.data))
    //   })
