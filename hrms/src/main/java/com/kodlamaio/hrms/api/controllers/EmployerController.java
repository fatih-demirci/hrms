...
public class EmployerController {
	...
	public DataResult<List<EmployerWithAdvertisementDto>> getEmployerWithAdvertisementDetails(@RequestParam boolean isOpen, @RequestParam boolean approved) {
		//return employerService.getAllJobAdvertisements(null);
		return employerService.getEmployerWithAdvertisementDetails(isOpen,approved);
	}
