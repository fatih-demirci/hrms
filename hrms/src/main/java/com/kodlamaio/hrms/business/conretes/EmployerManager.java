...
public class EmployerManager implements EmployerService{
	...
	@Override
	public DataResult<List<EmployerWithAdvertisementDto>>  getEmployerWithAdvertisementDetails(){

	 return new SuccessDataResult<List<EmployerWithAdvertisementDto>>(employerDao.getEmployerWithAdvertisementDetails(), "İlanlar listelendi");
	}
