...
public class EPTExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EPTDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EPTStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EPTDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EPTDateTimeConverter dateTimeConverter = new EPTStandardDateTimeConverter();

    public EPTExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EPTExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EPTMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EPTHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EPTExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EPTHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
