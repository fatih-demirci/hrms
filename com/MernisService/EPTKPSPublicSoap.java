...
public class EPTKPSPublicSoap
{
    ...
    public EPTKPSPublicSoap(){}

    public EPTKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EPTKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EPTExtendedSoapSerializationEnvelope envelope= new EPTExtendedSoapSerializationEnvelope(EPTExtendedSoapSerializationEnvelope.VER11);
