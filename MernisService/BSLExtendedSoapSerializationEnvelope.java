...
public class BSLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BSLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BSLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BSLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BSLDateTimeConverter dateTimeConverter = new BSLStandardDateTimeConverter();

    public BSLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BSLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BSLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BSLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BSLExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BSLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
