...
public class BSLKPSPublicSoap
{
    ...
    public BSLKPSPublicSoap(){}

    public BSLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BSLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BSLExtendedSoapSerializationEnvelope envelope= new BSLExtendedSoapSerializationEnvelope(BSLExtendedSoapSerializationEnvelope.VER11);
